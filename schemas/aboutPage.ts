          ...
          fields: [
            {
              ...
              type: "string",
              title: "Caption",
              description: "Optional, shown under the photo. e.g. 'Main gallery floor'. Without one the photo shows as Untitled in this list, which is fine.",
            },
          ],
        },
      ],
      description: "Photos of the gallery interior, shown in the 'Inside' section of the About page. Up to 12. Drag to change the order; the first comes first on the page.",
      validation: (rule) => rule.max(12).error("Up to 12 photos. Remove one to publish."),
    }),
    defineField({
